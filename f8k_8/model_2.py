...
class VSE(object):
    ...
    def __init__(self, opt):
        ...
        self.pre_optimizer = torch.optim.Adam(params, lr=opt.learning_rate*0.1)

        self.Eiters = 0
		
        self.lr_MI=opt.lr_MI
        self.lr_pre_MI = opt.lr_pre_MI
        self.MI=KLLoss()
    ...
    def state_dict(self):
        state_dict = [self.img_enc.state_dict(), self.txt_enc.state_dict(),self.MI.state_dict()]
        return state_dict

    def load_state_dict(self, state_dict):
        self.img_enc.load_state_dict(state_dict[0])
        self.txt_enc.load_state_dict(state_dict[1])
        self.MI.load_state_dict(state_dict[2])
    ...
    def forward_loss(self, img_emb, cap_emb, **kwargs):
        ...
        """
        text_fake = torch.cat((cap_emb[1:], cap_emb[0].unsqueeze(0)), dim=0) 
        loss=self.MI(cap_emb,img_emb,text_fake) 
        print('MI:{}'.format(loss))
        return loss
    ...
    def train_emb(self, images, captions, lengths, ids=None,pre=False, *args):
        ...
        """
        self.Eiters += 1
        print('Eiters:{}, lr:{}'.format(self.Eiters,self.optimizer.param_groups[0]['lr']))
